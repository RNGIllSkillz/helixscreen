...
static bool parse_command_line_args(
    ...
    bool& show_gcode_test, bool& show_bed_mesh, bool& force_wizard, int& wizard_step,
    ...
    for (int i = 1; i < argc; i++) {
        if (strcmp(argv[i], "-s") == 0 || strcmp(argv[i], "--size") == 0) {
            ...
            printf("  print-select, step-test, test, gcode-test\n");
            printf("\nScreen sizes:\n");
...
int main(int argc, char** argv) {
    ...
    if (!parse_command_line_args(
            ...
            show_test_panel, show_gcode_test, show_bed_mesh, force_wizard, wizard_step,
